...
const DIVISORS = {
  ...
  bird: 1 / 16000 // TODO: what is the division here??
  // 160 birds per hectarea.
};
...
export const HowMany = ({ percentage }) => {
  ...
  const howMany = React.useMemo(() => {
    return ((percentage / 100) * TOTAL_AREA) / DIVISORS[figure];
  }, [figure, percentage]);
      ...
      <div>
        ...
        <div className="flex-shapes">
          ...
          <p className="howmanynumber">
            {figure === "texas" && (
              <span className="howmany-text">
                Texas is 695,662 km<sup>2</sup>
              </span>
            )}
            {figure === "stadium" && (
              <span className="howmany-text">
                Stadium is 0.186 km<sup>2</sup>
              </span>
            )}
            {figure === "bird" && (
              <span className="howmany-text">
